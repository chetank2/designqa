...
export class StorageProvider {
  ...
  /**
   * Save a site profile
   * @param {Object} profileData - Site profile data
   * @param {Object} metadata - Metadata (id, etc.)
   * @returns {Promise<Object>} Saved profile data
   */
  async saveSiteProfile(profileData, metadata) {
    throw new Error('saveSiteProfile must be implemented by subclass');
  }

  /**
   * List site profiles
   * @param {Object} filters - Filter options
   * @returns {Promise<Array>} List of site profiles
   */
  async listSiteProfiles(filters = {}) {
    throw new Error('listSiteProfiles must be implemented by subclass');
  }

  /**
   * Get a site profile by ID
   * @param {string} profileId - Profile ID
   * @returns {Promise<Object>} Site profile data
   */
  async getSiteProfile(profileId) {
    throw new Error('getSiteProfile must be implemented by subclass');
  }
  ...
  async deleteSiteProfile(profileId) {
    throw new Error('deleteSiteProfile must be implemented by subclass');
  }
